...
$query = "SELECT `Event`, `Price` FROM `tickets`";
...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="text-align:right">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Electronic Ticket Exchange Service</a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
                <ul class="nav navbar-nav">
                    <li>
                        <a href="failedview.php">Events</a>
                    </li>
                    <li>
    ...
    <div class="container" >
        ...
        <header class="jumbotron hero-spacer">
            ...
            <p><a href = "failedview.php" class="btn btn-primary btn-large">View Events Here</a>
            </p>
        </header>
            ...
            <?php
                if (mysql_num_rows($result) > 0) {
                    ...
                    while($row = mysql_fetch_assoc($result)) {
                        ...
                        echo "<td>" . "<a href='failedview.php'><input type='button' value='Details'></a>" . "</td>";
                        echo "</tr>";
                    }
                } 
                else {
